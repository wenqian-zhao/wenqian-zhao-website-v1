    ...
    <Section className="bg-zinc-900" sectionId={SectionId.Contact}>
      <div className="flex flex-col gap-y-6">
        <div className="flex flex-col gap-6 md:flex-row md:items-center">
          <MailIcon className="hidden h-16 w-16 text-orange-100 md:block" />
          <h2 className="text-2xl font-bold text-orange-100">{headerText}</h2>
        </div>
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <div className="order-1 col-span-1 flex flex-col gap-y-4 md:order-2">
            <p className="prose leading-6 text-orange-100">{description}</p>
            <dl className="flex flex-col space-y-4 text-base text-orange-100 sm:space-y-2">
                  ...
                  <div key={srLabel}>
                    ...
                    <dd className="flex items-center">
                      <a
                        ...
                        href={href}
                        target="_blank">
                        <Icon aria-hidden="true" className="h-4 w-4 flex-shrink-0 text-orange-100 sm:h-5 sm:w-5" />
